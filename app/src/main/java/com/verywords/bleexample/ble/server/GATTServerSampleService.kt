...
package com.verywords.bleexample.ble.server
...
import com.verywords.bleexample.ui.toConnectionStateString
...
class GATTServerSampleService : Service() {
    ...
    override fun onCreate() {
        ...
        if (permission == PackageManager.PERMISSION_GRANTED) {
            ...
            serverLogsState.value = "GATT 서비스 중...\n"
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannelCompat.Builder(
            ...
            .setName("GATT Server channel Name")
            .setDescription("GATT Server Channel description")
            .build()
